/*- 
 * Classname:             AddDocumentDSGFrame.java 
 * 
 * Version information:   1.1
 * 
 * Date:                  02/08/2014 - 19:07:48 
 * 
...
/**
 * Adicionar documento DSG
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentDSGFrame implements AddDocumentInterface {
    //frame principal
    ...
    private DocumentDSG documentDSG;
    //título do frame
     ...
     */
    public AddDocumentDSGFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.DSG.getName();
        createView();
     ...
     *
     * @param documentDSG documento de almoxarifado
     * @param titleBook título do livro
     */
    public AddDocumentDSGFrame(DocumentDSG documentDSG, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.DSG.getName();
        this.documentDSG = documentDSG;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentDSG.getCodeDocumentSpecific());
        titleField.setText(documentDSG.getTitleDocument());
        observationField.setText(documentDSG.getObservationDocument());
     ...
     *
     * @return <code>DocumentDSG</code> documento
     */
    public DocumentDSG getDocument() {
        ...
        if (this.documentDSG != null) {
            documentDSG.setCodeDocument(this.documentDSG.getCodeDocument());
        }
        documentDSG.setCodeDocumentSpecific(Integer.valueOf(codeField.getText()));
        documentDSG.setTitleDocument(titleField.getText());
        documentDSG.setObservationDocument(observationField.getText());
        return documentDSG;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_DSG);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentDSGFrame addDocumentDSGFrame = new AddDocumentDSGFrame(0, "teste");

    }
}//fim da classe AddDocumentDSGFrame
