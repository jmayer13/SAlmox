/*- 
 * Classname:             AddDocumentDGFrame.java 
 * 
 * Version information:   1.1
 * 
 * Date:                  02/08/2014 - 19:08:26 
 * 
...
/**
 * Adiciona Documento DG
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentDGFrame implements AddDocumentInterface {
    //frame principal
     ...
     */
    public AddDocumentDGFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.DG.getName();
        createView();
     ...
     *
     * @param documentDG documento de almoxarifado
     * @param titleBook título do livro
     */
    public AddDocumentDGFrame(DocumentDG documentDG, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.DG.getName();
        this.documentDG = documentDG;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentDG.getCodeDocumentSpecific());
        titleField.setText(documentDG.getTitleDocument());
        observationField.setText(documentDG.getObservationDocument());
     ...
     *
     * @return <code>DocumentDG</code> documento
     */
    public DocumentDG getDocument() {
        ...
        if (this.documentDG != null) {
            documentDG.setCodeDocument(this.documentDG.getCodeDocument());
        }
        documentDG.setCodeDocumentSpecific(Integer.valueOf(codeField.getText()));
        documentDG.setTitleDocument(titleField.getText());
        documentDG.setObservationDocument(observationField.getText());
        return documentDG;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_DG);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentDGFrame addDocumentDGFrame = new AddDocumentDGFrame(0, "teste");

    }
}//fim da classe AddDocumentDGFrame
