...
/*-
 * Classname:             AddDocumentCCFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  11/04/2013 - 13:51:24
 *
...
/**
 * Janela para cadastro e edição de documento de cadernos de chamada
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentCCFrame implements AddDocumentInterface {
    ...
    //documento de cadernos de chamada
    private DocumentCC documentCC;
    //título do frame
    ...
    /**
     * Construtor para cadastro com caixa e livro do cadernos de chamada
     *
     * @param codeSugered código sugerido
     * @param titleBook título do livro
     */
    public AddDocumentCCFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.CC.getName();
        createView();
        codeField.setText("" + codeSugered);
    }//fim do construtor de cadastro

    /**
     * Construtor para edição com caixa, livro e documento de cadernos de
     * chamada
     *
     * @param documentC documento de cadernos de chamada
     * * @param titleBook título do livro
     */
    public AddDocumentCCFrame(DocumentCC documentCC, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.CC.getName();
    ...
    private void createView() {
        ...
        semesterComboBox = new JComboBox(new Object[]{"1º Semestre", "2º Semestre"});
        ...
        yearField.setBounds(140, 160, 250, 30);
        semesterComboBox.setBounds(140, 210, 250, 30);
        ...
        semesterComboBox.setForeground(Color.BLACK);
        ...
        semesterComboBox.setFont(FontFactory.getFontDefault());
        ...
        yearField.setToolTipText("Insira a data do documento");
        semesterComboBox.setToolTipText("Defina o semestre do documento");
    ...
    private void fillsView() {
        codeField.setText("" + documentCC.getCodeDocumentCC());
        titleField.setText(documentCC.getTitleDocument());
        yearField.setText("" + documentCC.getYear());
        semesterComboBox.setSelectedIndex(documentCC.getSemester() - 1);
        observationField.setText(documentCC.getObservationDocument());
     ...
     *
     * @return <code>DocumentCC</code> documento
     */
    public DocumentCC getDocument() {
        ...
        if (yearField.getText() == null || yearField.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Informe o ano do documento!", "Atenção!", JOptionPane.WARNING_MESSAGE);
            return null;
        }
        DocumentCC documentCC = new DocumentCC();
        if (this.documentCC != null) {
            documentCC.setCodeDocument(this.documentCC.getCodeDocument());
        }
        documentCC.setCodeDocumentCC(Integer.valueOf(codeField.getText()));
        documentCC.setTitleDocument(titleField.getText());
        documentCC.setYear(Integer.valueOf(yearField.getText()));
        documentCC.setSemester(semesterComboBox.getSelectedIndex() + 1);
        documentCC.setObservationDocument(observationField.getText());
        return documentCC;
    ...
    public void setKeyListenerFrame(KeyListener keyListener) {
        ...
        semesterComboBox.addKeyListener(keyListener);
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_CC);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentCCFrame addDocumentCCFrame = new AddDocumentCCFrame(0, "teste");
    }
}//fim da classe AddDocumentCCFrame
