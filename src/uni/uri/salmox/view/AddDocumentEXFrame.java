...
/*-
 * Classname:             AddDocumentEXFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  15/04/2013 - 13:52:29
 *
...
/**
 * Janela para cadastro e edição de documento de ex-alunos
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentEXFrame implements AddDocumentInterface {
    ...
    //documento de ex-alunos
    private DocumentEX documentEX;
    //título do frame
    ...
    /**
     * Construtor para cadastro com caixa e livro do ex-alunos
     *
     * @param codeSugered código sugerido
     * @param titleBook título do livro
     */
    public AddDocumentEXFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.EX.getName();
        createView();
     ...
     *
     */
    public AddDocumentEXFrame(DocumentEX documentEX, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.EX.getName();
        this.documentEX = documentEX;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentEX.getCodeDocumentEX());
        titleField.setText(documentEX.getTitleDocument());
        yearField.setText("" + documentEX.getYear());
        observationField.setText(documentEX.getObservationDocument());
     ...
     *
     * @return <code>DocumentEX</code> documento
     */
    public DocumentEX getDocument() {
        ...
        if (this.documentEX != null) {
            documentEX.setCodeDocument(this.documentEX.getCodeDocument());
        }
        documentEX.setCodeDocumentEX(Integer.valueOf(codeField.getText()));
        documentEX.setTitleDocument(titleField.getText());
        documentEX.setYear(Integer.valueOf(yearField.getText()));
        documentEX.setObservationDocument(observationField.getText());
        return documentEX;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_EX);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentEXFrame addDocumentEXFrame = new AddDocumentEXFrame(0, "teste");
    }
}//fim da classe AddDocumentEXFrame
