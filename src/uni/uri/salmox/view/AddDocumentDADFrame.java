/*- 
 * Classname:             AddDocumentDADFrame.java 
 * 
 * Version information:   1.1
 * 
 * Date:                  02/08/2014 - 19:08:09 
 * 
...
/**
 * Adiciona o documento DAD
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentDADFrame implements AddDocumentInterface {
    //frame principal
    ...
    private DocumentDAD documentDAD;
    //título do frame
     ...
     */
    public AddDocumentDADFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.DAD.getName();
        createView();
     ...
     *
     * @param documentDAD documento de almoxarifado
     * @param titleBook título do livro
     */
    public AddDocumentDADFrame(DocumentDAD documentDAD, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.DAD.getName();
        this.documentDAD = documentDAD;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentDAD.getCodeDocumentSpecific());
        titleField.setText(documentDAD.getTitleDocument());
        observationField.setText(documentDAD.getObservationDocument());
     ...
     *
     * @return <code>DocumentDAD</code> documento
     */
    public DocumentDAD getDocument() {
        ...
        if (this.documentDAD != null) {
            documentDAD.setCodeDocument(this.documentDAD.getCodeDocument());
        }
        documentDAD.setCodeDocumentSpecific(Integer.valueOf(codeField.getText()));
        documentDAD.setTitleDocument(titleField.getText());
        documentDAD.setObservationDocument(observationField.getText());
        return documentDAD;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_DAD);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentDADFrame addDocumentDADFrame = new AddDocumentDADFrame(0, "teste");

    }
}//fim da classe AddDocumentDADFrame
