...
/*-
 * Classname:             AddDocumentSAEFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  15/04/2013 - 15:09:16
 *
 ...
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentSAEFrame implements AddDocumentInterface {
    //frame principal
    ...
    private DocumentSAE documentSAE;
    //título do frame
    ...
    /**
     * Construtor para cadastro com caixa e livro do filantropia
     *
     * @param codeSugered código sugerido
     * @param titleBook títuko do livro
     */
    public AddDocumentSAEFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.SAE.getName();
        createView();
        codeField.setText("" + codeSugered);
    }//fim do construtor de cadastro

    /**
     * Construtor para edição com caixa, livro e documento de filantropia
     *
     * @param titleBook título do livro
     * @param documentSAE documento de filantropia
     */
    public AddDocumentSAEFrame(DocumentSAE documentSAE, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.SAE.getName();
        this.documentSAE = documentSAE;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentSAE.getCodeDocumentSAE());
        titleField.setText(documentSAE.getTitleDocument());
        observationField.setText(documentSAE.getObservationDocument());
     ...
     *
     * @return <code>DocumentSAE</code> documento
     */
    public DocumentSAE getDocument() {
        ...
        if (this.documentSAE != null) {
            documentSAE.setCodeDocument(this.documentSAE.getCodeDocument());
        }
        documentSAE.setCodeDocumentSAE(Integer.valueOf(codeField.getText()));
        documentSAE.setTitleDocument(titleField.getText());
        documentSAE.setObservationDocument(observationField.getText());
        return documentSAE;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_SAE);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentSAEFrame addDocumentSAEFrame = new AddDocumentSAEFrame(0, "teste");
