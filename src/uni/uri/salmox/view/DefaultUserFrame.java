...
/*-
 * Classname:             DefaultUserFrame.java
 *
 * Version information:   1.1
 *
 * Date:                  30/01/2013 - 14:32:14
 *
...
/**
 * Visão da janela principal do usuário padrão
 *
 * @see uni.uri.salmox.view.FrameInterface
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class DefaultUserFrame {
    ...
    //Item do Menu abrir caixa, financeiro e cobrança
    ...
    private void createView() {
        ...
        frame = new JFrame("Sistema de Gerência de Documentos do Arquivo Central da URI - Usuário");
        ...
        saeMenuItem = new JMenuItem("SAE - Filantropia");
        ...
        searchMenu.setBounds(80, 0, 60, 35);
        withdrawawMenu.setBounds(140, 0, 75, 35);
        systemMenu.setBounds(215, 0, 65, 35);
        helpMenu.setBounds(280, 0, 50, 35);
        //itens do menu acrir caixa
        fMenuItem.setBounds(0, 35, 200, 30);
        fcMenuItem.setBounds(0, 35, 200, 30);
        exMenuItem.setBounds(0, 65, 200, 30);
        aeMenuItem.setBounds(0, 95, 200, 30);
        ccMenuItem.setBounds(0, 125, 200, 30);
        fpMenuItem.setBounds(0, 155, 200, 30);
        mcMenuItem.setBounds(0, 185, 200, 30);
        dpMenuItem.setBounds(0, 215, 200, 30);
        saeMenuItem.setBounds(0, 245, 200, 30);
        aMenuItem.setBounds(0, 275, 200, 30);
        //itens do menu buscar
        searchMenuItem.setBounds(250, 35, 100, 30);
        //itens do menu retiradas
        requestMenuItem.setBounds(310, 35, 100, 30);
        historyMenuItem.setBounds(310, 65, 100, 30);
        //itens do menu sistema
    ...
    /**
     * Define ouvinte para menu de financeiro e cobrança
     *
     * @param actionListener ouvinte de evento
     */
    ...
    //Método main para teste de interface
    public static void main(String args[]) {
        DefaultUserFrame defaultUserFrame = new DefaultUserFrame();
        defaultUserFrame.changePanel(new WallpaperPanel());
    }//fim do método main
}//fim da classe DefaultUserFrame
