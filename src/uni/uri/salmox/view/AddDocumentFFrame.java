...
/*-
 * Classname:             AddDocumentFFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  15/04/2013 - 14:14:33
 *
...
/**
 * Janela para cadastro e edição de documento de formandos
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentFFrame implements AddDocumentInterface {
     ...
     */
    public AddDocumentFFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.F.getName();
        createView();
        codeField.setText("" + codeSugered);
    }//fim do construtor de cadastro

    /**
     * Construtor para edição com caixa, livro e documento de formandos
     *
     * @param documentC documento de formandos
     * @param titleBook título do livro
     *
     */
    public AddDocumentFFrame(DocumentF documentF, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.F.getName();
    ...
    private void fillsView() {
        codeField.setText("" + documentF.getCodeDocumentF());
        titleField.setText(documentF.getTitleDocument());
        observationField.setText(documentF.getObservationDocument());
     ...
     *
     * @return <code>DocumentF</code> documento
     */
    public DocumentF getDocument() {
        ...
        if (this.documentF != null) {
            documentF.setCodeDocument(this.documentF.getCodeDocument());
        }
        documentF.setCodeDocumentF(Integer.valueOf(codeField.getText()));
        documentF.setTitleDocument(titleField.getText());
        documentF.setObservationDocument(observationField.getText());
        return documentF;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_F);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentFFrame addDocumentFFrame = new AddDocumentFFrame(0, "teste");
    }
}//fim da classe AddDocumentFFrame
