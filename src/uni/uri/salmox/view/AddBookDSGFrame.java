/*- 
 * Classname:             AddBookDSG.java 
 * 
 * Version information:   1.1
 * 
 * Date:                  02/08/2014 - 17:10:34 
 * 
...
/**
 * janela para adição livro DSG
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddBookDSGFrame implements AddBookInterface {
     ...
     */
    public AddBookDSGFrame(int codeSugered, String titleBox) {
        this.titleBox = titleBox;
        title = "Adicionar livro - " + Category.DSG.getName();
        createView();
     ...
     */
    public AddBookDSGFrame(String titleBox, BookDSG bookDSG) {
        this.bookDSG = bookDSG;
        this.titleBox = titleBox;
        title = "Editar livro - " + Category.DSG.getName();
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + bookDSG.getCodeBookSpecific());
        courseField.setText(bookDSG.getTitleBook());
        String year = bookDSG.getYear();
        yearNoneRadioButton.setSelected(false);
        if (year == null) {
            yearNoneRadioButton.setSelected(true);
        ...
        observationField.setText(bookDSG.getObservationBook());
    ...
    public BookDSG getBook() {
        ...
        try {
            bookDSG.setCodeBookSpecific(Integer.valueOf(codeField.getText()));
            bookDSG.setTitleBook(courseField.getText());
            if (intervalRadioButton.isSelected()) {
                bookDSG.setYear(firstIntervalField.getText() + "-" + secondIntervalField.getText());
            } else if (yearRadioButton.isSelected()) {
                bookDSG.setYear(yearField.getText());
            }
            bookDSG.setObservationBook(observationField.getText());
            return bookDSG;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_BOOK_DSG);
    }//fim do método getColor

    //método para testes
    public static void main(String args[]) {
        uni.uri.salmox.view.AddBookDSGFrame addBookDSGFrame = new uni.uri.salmox.view.AddBookDSGFrame(0, "test");
        List<String> list = new ArrayList();
        list.add("teste");
        addBookDSGFrame.setCourseList(list);
    }
}//fim da classe AddBookDSG 
