...
/*-
 * Classname:             AddBookEXFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  04/04/2013 - 13:59:27
 *
...
/**
 * Janela para cadastro e edição de livros de Ex-alunos
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddBookEXFrame implements AddBookInterface {
    ...
    /**
     * Construtor para cadastro de livro de ex-alunos
     *
     * @param codeSugered código sugerido (ultimo código cadastrado +1)
     * @param titleBox título da caixa
     */
    public AddBookEXFrame(int codeSugered, String titleBox) {
        this.titleBox = titleBox;
        title = "Adicionar livro - " + Category.EX.getName();
        createView();
    ...
    /**
     * Construtor para edição de livro de ex-alunos
     *
     * @param titleBox título da caixa
     * @param bookEX livro de ex-alunos
     */
    public AddBookEXFrame(String titleBox, BookEX bookEX) {
        this.bookEX = bookEX;
        this.titleBox = titleBox;
        title = "Editar livro - " + Category.EX.getName();
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + bookEX.getCodeBookEX());
        courseField.setText(bookEX.getTitleBook());
        observationField.setText(bookEX.getObservationBook());
     ...
     *
     * @return <code>BookEX</code> livro de ex-alunos
     */
    public BookEX getBook() {
        ...
        try {
            bookEX.setCodeBookSpecific(Integer.valueOf(codeField.getText()));
            bookEX.setTitleBook(courseField.getText());
            bookEX.setObservationBook(observationField.getText());
            return bookEX;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_BOOK_EX);
    }//fim do método getColor

    //método para testes
    public static void main(String args[]) {
        AddBookEXFrame addBookEXFrame = new AddBookEXFrame(0, "test");
        List<String> list = new ArrayList();
        list.add("teste");
        addBookEXFrame.setCourseList(list);
    }
}//fim da classe AddBookEXFrame
