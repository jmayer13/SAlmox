...
/*-
 * Classname:             AddBookDPFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  04/04/2013 - 13:37:03
 *
...
/**
 * Janela para cadastro e edição de livros de departamento pessoal Descrição
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddBookDPFrame implements AddBookInterface {
    ...
    //livro departamento pessoal
    private BookDP bookDP;
    //largura da tela
    private int x;
    //altura da tela
    private int y;
    ...
    /**
     * Construtor para cadastro de livro de departamento pessoal
     *
     * @param codeSugered código sugerido (ultimo código cadastrado +1)
     * @param titleBox título da caixa
     */
    public AddBookDPFrame(int codeSugered, String titleBox) {
        this.titleBox = titleBox;
        title = "Adicionar livro - " + Category.DP.getName();
        createView();
    ...
    /**
     * Construtor para edição de livro de departamento pessoal
     *
     * @param titleBox título da caixa
     * @param bookDP livro de departamento pessoal
     */
    public AddBookDPFrame(String titleBox, BookDP bookDP) {
        this.bookDP = bookDP;
        this.titleBox = titleBox;
        title = "Editar livro - " + Category.DP.getName();
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + bookDP.getCodeBookDP());
        yearField.setText("" + bookDP.getYear());
        observationField.setText(bookDP.getObservationBook());
     ...
     *
     * @return <code>BookDP</code> livro de departamento pessoal
     */
    public BookDP getBook() {
        ...
        try {
            bookDP.setCodeBookSpecific(Integer.valueOf(codeField.getText()));
            bookDP.setYear(Integer.valueOf(yearField.getText()));
            bookDP.setObservationBook(observationField.getText());
            return bookDP;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_BOOK_DP);
    }//fim do método getColor

    //método para testes
    public static void main(String args[]) {
        AddBookDPFrame addBookDPFrame = new AddBookDPFrame(0, "test");
    }
}//fim da classe AddBookDPFrame
