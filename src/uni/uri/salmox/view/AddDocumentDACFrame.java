/*- 
 * Classname:             AddDocumentDACFrame.java 
 * 
 * Version information:   1.1
 * 
 * Date:                  02/08/2014 - 19:07:00 
 * 
...
/**
 * Adiciona documento DAC
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentDACFrame implements AddDocumentInterface {
    //frame principal
    ...
    private DocumentDAC documentDAC;
    //título do frame
     ...
     */
    public AddDocumentDACFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.DAC.getName();
        createView();
     ...
     *
     * @param documentDAC documento de almoxarifado
     * @param titleBook título do livro
     */
    public AddDocumentDACFrame(DocumentDAC documentDAC, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.DAC.getName();
        this.documentDAC = documentDAC;
        createView();
        fillsView();
    ...
    private void fillsView() {
        codeField.setText("" + documentDAC.getCodeDocumentSpecific());
        titleField.setText(documentDAC.getTitleDocument());
        observationField.setText(documentDAC.getObservationDocument());
     ...
     *
     * @return <code>DocumentDAC</code> documento
     */
    public DocumentDAC getDocument() {
        ...
        if (this.documentDAC != null) {
            documentDAC.setCodeDocument(this.documentDAC.getCodeDocument());
        }
        documentDAC.setCodeDocumentSpecific(Integer.valueOf(codeField.getText()));
        documentDAC.setTitleDocument(titleField.getText());
        documentDAC.setObservationDocument(observationField.getText());
        return documentDAC;
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_DAC);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentDACFrame addDocumentDACFrame = new AddDocumentDACFrame(0, "teste");

    }
}//fim da classe AddDocumentDACFrame
