...
/*-
 * Classname:             AddDocumentFPFrame.java
 *
 * Version information:   1.0
 *
 * Date:                  15/04/2013 - 14:27:18
 *
...
/**
 * Janela para cadastro e edição de documento de formandos pós-graduação
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class AddDocumentFPFrame implements AddDocumentInterface {
    ...
    //documento de formandos pós-graduação
    private DocumentFP documentFP;
    //título do frame
    ...
    /**
     * Construtor para cadastro com caixa e livro do formandos pós-graduação
     *
     * @param codeSugered código sugerido
     * @param titleBook título do livro
     */
    public AddDocumentFPFrame(int codeSugered, String titleBook) {
        local = titleBook;
        title = "Adicionar Documento - " + Category.FP.getName();
        createView();
        codeField.setText("" + codeSugered);
    }//fim do construtor de cadastro

    /**
     * Construtor para edição com caixa, livro e documento de cadernos de chmada
     *
     * @param documentC documento de cadernos de chmada
     * @param titleBook título dolivro
     *
     */
    public AddDocumentFPFrame(DocumentFP documentFP, String titleBook) {
        local = titleBook;
        title = "Editar Documento - " + Category.FP.getName();
        this.documentFP = documentFP;
        createView();
        fillsView();
    ...
    private void createView() {
        ...
        statusComboBox = new JComboBox(new Object[]{"", "Egresso", "Desistente", "Aluno Especial"});
        ...
        statusLabel.setBounds(30, 160, 120, 30);
        observationLabel.setBounds(30, 210, 100, 30);
        codeField.setBounds(140, 60, 100, 30);
        titleField.setBounds(140, 110, 250, 30);
        statusComboBox.setBounds(140, 160, 250, 30);
        scrollPane.setBounds(140, 210, 250, 150);
        ...
        statusComboBox.setFont(FontFactory.getFontDefault());
        ...
        titleField.setToolTipText("Insira o nome do aluno");
        statusComboBox.setToolTipText("Defina o estado do aluno");
    ...
    private void fillsView() {
        codeField.setText("" + documentFP.getCodeDocumentFP());
        titleField.setText(documentFP.getTitleDocument());
        statusComboBox.setSelectedItem(documentFP.getStatusStudent());
        observationField.setText(documentFP.getObservationDocument());
    ...
    public DocumentFP getDocument() {
        ...
        if (this.documentFP != null) {
            documentFP.setCodeDocument(this.documentFP.getCodeDocument());
        }
        documentFP.setCodeDocumentFP(Integer.valueOf(codeField.getText()));
        documentFP.setTitleDocument(titleField.getText());
        documentFP.setStatusStudent((String) statusComboBox.getSelectedItem());
        documentFP.setObservationDocument(observationField.getText());
        return documentFP;
    ...
    public void setKeyListenerFrame(KeyListener keyListener) {
        ...
        statusComboBox.addKeyListener(keyListener);
    ...
    private Color getColor() {
        ...
        return colorConverter.getColor(PreferencesManager.KEY_COLOR_DOCUMENT_FP);
    }//fim do método getColor

    //método para testes
    public static void main(String[] args) {
        AddDocumentFPFrame addDocumentFPFrame = new AddDocumentFPFrame(0, "tweste");
    }
}//fim da classe AddDocumentFPFrame
