/*-
 * Classname:             DevolutionDocumentTableModel.java
 *
 * Version information:   1.0
 *
 * Date:                  30/04/2013 - 14:02:09
 *
...
/**
 * Modelo para tabela de devolução de documentos
 *
 * @see
 * @author Jonas Mayer (jmayer13@hotmail.com)
 */
public class DevolutionDocumentTableModel extends AbstractTableModel {
     ...
     */
    public DevolutionDocumentTableModel() {
     ...
     */
    public DevolutionDocumentTableModel(List<Withdrawal> withdrawals) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (columnIndex == COLUMN_CODE) {
            ...
            if (withdrawal.getDateWithdrawal() != null) {
...
}//fim da classe DevolutionDocumentTableModel 
